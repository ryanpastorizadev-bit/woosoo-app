...
use App\Http\Controllers\Api\V1\Device\PosContextController;
...
Route::prefix('v1/device')->group(function (): void {
    ...
    Route::middleware('device')->group(function (): void {
        Route::get('pos/readiness', [PosContextController::class, 'readiness']);
        Route::get('pos/tables', [PosContextController::class, 'tables']);
